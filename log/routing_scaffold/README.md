...
**Status:** active (started 2026-07-02). **2026-08-06: the tree is now portable** — exported to `~/tofu-routing` (see the entry below); porting to a new cluster is one `cluster_env.<site>.sh`. First reproduction of the project's headline
