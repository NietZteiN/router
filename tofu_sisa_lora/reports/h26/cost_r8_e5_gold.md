...
Survivors: 180 · full-scoring AUC **0.999**

| m (fwd/query) | speedup | probe AUC | best-conf AUC | FPR@90% catch | own-expert recall |
|---|---|---|---|---|---|
| 2 | 90x | **0.997** | 0.988 | 0.005 | 0.998 |
| 4 | 45x | **0.998** | 0.994 | 0.005 | 1.000 |
| 8 | 22x | **0.997** | 0.995 | 0.005 | 1.000 |
| 16 | 11x | **0.999** | 0.995 | 0.005 | 1.000 |
| 32 | 6x | **0.999** | 0.996 | 0.005 | 1.000 |
| 64 | 3x | **0.999** | 0.992 | 0.005 | 1.000 |
| 180 | 1x | **0.999** | 0.993 | 0.005 | 1.000 |
