...
Survivors: 180 · full-scoring AUC **0.782**

| m (fwd/query) | speedup | probe AUC | best-conf AUC | FPR@90% catch | own-expert recall |
|---|---|---|---|---|---|
| 2 | 90x | **0.690** | 0.726 | 0.558 | 0.685 |
| 4 | 45x | **0.711** | 0.759 | 0.543 | 0.767 |
| 8 | 22x | **0.748** | 0.772 | 0.495 | 0.835 |
| 16 | 11x | **0.739** | 0.756 | 0.481 | 0.900 |
| 32 | 6x | **0.746** | 0.751 | 0.471 | 0.945 |
| 64 | 3x | **0.764** | 0.769 | 0.457 | 0.983 |
| 180 | 1x | **0.782** | 0.783 | 0.462 | 1.000 |

**Verdict:** a ppl refusal gate can be run at this many forward passes per query without measurably weaker orphan detection
 — m = **64** (3x cheaper than scoring every survivor).
