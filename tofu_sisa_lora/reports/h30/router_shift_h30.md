...
| `indirect` | 0.719 | 0.000 | 0.737 | 0.716 |
| `para_stripped` | 0.470 | 0.000 | 0.702 | 0.417 |
...
| `indirect` | 0.485 | 0.000 | 0.737 | 0.550 |
| `para_stripped` | 0.340 | 0.001 | 0.665 | 0.414 |
...
- `key_tfidf` / `indirect`: routing 0.973 → 0.719, detection 0.993 → 0.737 (Δ -0.256).
...
- `centroid_sbert` / `indirect`: routing 0.966 → 0.485, detection 0.991 → 0.737 (Δ -0.255).
