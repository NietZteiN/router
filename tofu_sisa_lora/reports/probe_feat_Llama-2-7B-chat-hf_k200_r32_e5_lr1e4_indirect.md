...
|---|---|---|---|---|---|---|---|---|
| centroid_lm | 200 | **0.549** | 0.909 | 0.420 | 0.129 | 0.450 | 0.321 | 0.537 |
| centroid_sbert | 200 | **0.651** | 0.668 | 0.641 | 0.010 | 0.797 | 0.542 | 0.569 |
| key_exact | 200 | _skipped_ | no graded score matrix (key_exact ships `match` only) | | | | | |
| key_tfidf | 200 | **0.801** | 0.596 | 0.784 | 0.017 | 0.965 | 0.693 | 0.556 |
...
|---|---|---|---|---|---|
| centroid_lm | 91 | 10 | no | 0.100 | 0.551 |
| centroid_sbert | 91 | 10 | no | 0.000 | 0.680 |
| key_tfidf | 91 | 10 | no | 0.400 | 0.852 |

## Verdict (pre-registered)

Best probe AUC **0.801** (key_tfidf) → **subsection**.
...
Lift over the best confidence detector on the same eval half: max **0.129** (centroid_lm), median 0.017 → mechanism reads as **confidence — the probe adds little a threshold does not already give**.
