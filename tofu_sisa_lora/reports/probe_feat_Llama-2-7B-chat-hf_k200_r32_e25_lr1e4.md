...
|---|---|---|---|---|---|---|---|---|
| centroid_lm | 200 | **0.825** | 0.471 | 0.744 | 0.081 | 0.883 | 0.431 | 0.578 |
| centroid_sbert | 200 | **0.982** | 0.034 | 0.980 | 0.002 | 0.999 | 0.472 | 0.517 |
| key_exact | 200 | _skipped_ | no graded score matrix (key_exact ships `match` only) | | | | | |
| key_tfidf | 200 | **0.991** | 0.029 | 0.991 | -0.000 | 1.000 | 0.371 | 0.535 |
...
|---|---|---|---|---|---|
| centroid_lm | 91 | 10 | yes | 0.400 | 0.893 |
| centroid_sbert | 91 | 10 | no | 0.800 | 0.981 |
| key_tfidf | 91 | 10 | yes | 0.800 | 0.994 |

## Verdict (pre-registered)

Best probe AUC **0.991** (key_tfidf) → **headline (§4.9)**.
...
Lift over the best confidence detector on the same eval half: max **0.081** (centroid_lm), median 0.002 → mechanism reads as **confidence — the probe adds little a threshold does not already give**.
